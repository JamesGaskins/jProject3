...
public class Term implements Comparable<Term> {
    ...
    private static class PrefixOrder implements Comparator<Term> {
        ...
        public int compare(Term v, Term w) {
            int lengthOfv = Math.min(r, v.query.length());
            int lengthOfw = Math.min(r, w.query.length());
            String a = v.query.substring(0, lengthOfv);
            String b = w.query.substring(0, lengthOfw);
